          ...
          spec = {
            containers.api = {
              ...
              env = [
                ...
                { name = "JWT_SECRET_KEY";    valueFrom.secretKeyRef = { name = "platform-secrets"; key = "jwt_secret"; }; }
                { name = "STRIPE_SECRET_KEY"; valueFrom.secretKeyRef = { name = "platform-secrets"; key = "stripe_secret_key"; }; }
